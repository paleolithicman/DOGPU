...
void SelectionDAGBuilder::visitInlineAsm(ImmutableCallSite CS) {
  ...
  for (unsigned i = 0, e = ConstraintOperands.size(); i != e; ++i) {
    ...
    case InlineAsm::isInput: {
      ...
      DEBUG(dbgs() << "dsheffie : " << __FILE__ << ":" << __PRETTY_FUNCTION__ << ":" << __LINE__ << "\n");
	...
	DEBUG(dbgs() << "dsheffie : " << __FILE__ << ":" << __PRETTY_FUNCTION__ << ":" << __LINE__ << "\n");
      ...
      //dbsheffi - this is where we're dying
      DEBUG(dbgs() << "dsheffie : " << __FILE__ << ":" << __PRETTY_FUNCTION__ << ":" << __LINE__ << "\n");
      DEBUG(dbgs() << "dsheffie : OpInfo.AssignedRegs.Regs.size() = " << OpInfo.AssignedRegs.Regs.size() << "\n");
