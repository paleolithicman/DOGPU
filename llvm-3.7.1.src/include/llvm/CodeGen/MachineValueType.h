...
class MVT {
  public:
    enum SimpleValueType {
      ...
      LAST_INTEGER_VECTOR_VALUETYPE = v128i8,
      ...
      LAST_FP_VECTOR_VALUETYPE = v32f32,

      FIRST_VECTOR_VALUETYPE = v2i1,
      LAST_VECTOR_VALUETYPE  = v32f32,

      x86mmx         =  57,   // This is an X86 MMX value

      Glue           =  58,   // This glues nodes together during pre-RA sched

      isVoid         =  59,   // This has no value

      Untyped        =  60,   // This value takes a register, but has
                              // unspecified type.  The register class
                              // will be determined by the opcode.

      FIRST_VALUETYPE = 0,    // This is always the beginning of the list.
      LAST_VALUETYPE =  61,   // This always remains at the end of the list.
