...
#N_THREADS=1
N_THREADS=$(getconf _NPROCESSORS_ONLN)               # number of threads for compilation
...
cd "$SCRIPTS_DIR/.." # go to FGPU main directory
...
ln -srf "$SRC/CMakeLists.txt"                      "$DST/"
ln -srf "$SRC/cmake/config-ix.cmake"               "$DST/cmake/"
ln -srf "$SRC/include/llvm/ADT/Triple.h"           "$DST/include/llvm/ADT/"
ln -srf "$SRC/include/llvm/Object/ELFObjectFile.h" "$DST/include/llvm/Object/"
ln -srf "$SRC/include/llvm/Support/ELF.h"          "$DST/include/llvm/Support/"
ln -srf "$SRC/lib/Support/Triple.cpp"              "$DST/lib/Support/"
ln -srf "$SRC/lib/Target/LLVMBuild.txt"            "$DST/lib/Target/"
ln -srf "$SRC/lib/Target/Fgpu/"                    "$DST/lib/Target/"
